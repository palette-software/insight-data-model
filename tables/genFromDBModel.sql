...
CREATE TABLE "p_cpu_usage"(
 ...
 "cpu_time_consumption_minutes" Double precision,
 ...
 "max_reporting_granularity" Boolean,
...
;
COMMENT ON COLUMN "p_cpu_usage"."session_start_ts" IS '

ETL: min(serverlogs.ts)'
;
COMMENT ON COLUMN "p_cpu_usage"."session_end_ts" IS '

ETL: destroy session ts from serverlogs'
;
