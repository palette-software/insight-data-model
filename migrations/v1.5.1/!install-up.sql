...
insert into p_process_class_agg_report
        ...
        'dataserver', 'filestore', 'tabadmsvc', 'tabadmwrk', 'tdeserver', 'wgserver') then cpu_usage_process_name
                else 'Non-Tableau'
            end as process_name,
            cpu_usage_host_name,
        ...
        'vizportal', 'zookeeper', 'tabprotosrv', 'tableau', 'clustercontroller',
        'tabspawn', 'redis-server', 'tabadminservice', 'tabsvc', 'postgres',
        'dataserver', 'filestore', 'tabadmsvc', 'tabadmwrk', 'tdeserver', 'wgserver') then true
                else false
