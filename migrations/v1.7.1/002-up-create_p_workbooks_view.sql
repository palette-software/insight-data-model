...
group by
wb.p_id, wb.id, wb.name, wb.repository_url, wb.description, wb.created_at, wb.updated_at, wb.owner_id, wb.project_id, wb.view_count, wb.size, wb.embedded, wb.thumb_user, wb.refreshable_extracts, wb.extracts_refreshed_at, wb.lock_version, wb.state, wb.version, wb.checksum, wb.display_tabs, wb.data_engine_extracts, wb.incrementable_extracts, wb.site_id, wb.revision, wb.repository_data_id, wb.repository_extract_data_id, wb.first_published_at, wb.primary_content_url, wb.share_description, wb.show_toolbar, wb.extracts_incremented_at, wb.default_view_index, wb.luid, wb.asset_key_id, wb.document_version, wb.p_cre_date, wb.p_active_flag, wb.p_valid_from, wb.p_valid_to, wb.p_filepath, wb.content_version, wb.last_published_at, ((p.name::text || ' ('::text) || p.id::text) || ')'::text, ((s.name::text || ' ('::text) || s.id::text) || ')'::text, ((wb_su.name::text || ' ('::text) || wb.owner_id::text) || ')'::text, ((wb.name::text || ' ('::text) || wb.id::text) || ')'::text, 'WORKBOOK'::text
;
