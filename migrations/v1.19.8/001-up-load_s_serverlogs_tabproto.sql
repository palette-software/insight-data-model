...
begin    
    ...
    v_sql_cur := 'select distinct host_name 
                ...
                where
                    ...
                    and ts < date''#v_load_date_txt#'' + interval''1 day''
                order by 1
                ';        
    ...
    loop
        ...
        with t_s_spawner as
            ...
            from
                ...
                where
                    sl.keep_this_line
                    and tinfo.start_ts <= date''#v_load_date_txt#'' + interval''26 hours''
            )
            ...
            from
                ...
                from
                    ...
                    where 1 = 1
                        ...
                        and substr(regexp_replace(filename, ''^nativeapi_?'', ''''), 1, 11) = ''tabprotosrv''
                        ) s_tabproto
        ...
        v_num_inserted_all := v_num_inserted_all + coalesce(v_num_inserted, 0);
    end loop;
    close c;
