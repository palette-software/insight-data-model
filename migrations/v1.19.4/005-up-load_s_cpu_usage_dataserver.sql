...
begin		
	...
	loop
        ...
        execute 'truncate table s_cpu_usage_dataserver_slogs';
    
        v_sql :=
                'insert into s_cpu_usage_dataserver_slogs
				select
					slogs.*	
				from 
        ...
        execute v_sql; 
        analyze s_cpu_usage_dataserver_slogs;
         
        execute 'truncate table s_cpu_usage_dataserver_tri';
        
        v_sql := 'insert into s_cpu_usage_dataserver_tri
                 select 
							p_id
					       ,threadinfo_id
					       ,host_name
        ...
        v_sql := replace(v_sql, '#v_load_date_txt#', v_load_date_txt);
        execute v_sql;
        analyze s_cpu_usage_dataserver_tri;
		...
		v_sql := 
    				...
    				FROM 
    					...
    					from	
    						s_cpu_usage_dataserver_tri tri
    						left outer join s_cpu_usage_dataserver_slogs slogs ON (
                       ...
                       /*inner join (select
                                	...
                                	from	
                                		s_cpu_usage_dataserver_tri tri2
                                		left outer join s_cpu_usage_dataserver_slogs slogs ON (
