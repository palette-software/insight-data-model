...
BEGIN
		...
		elsif lower(p_table_name) in ('plainlogs', 'p_cpu_usage_agg_report', 'p_interactor_session', 'p_process_class_agg_report', 'p_cpu_usage_bootstrap_rpt', 'p_serverlogs_bootstrap_rpt', 'p_http_requests', 'p_background_jobs', 'p_async_jobs', 'p_desktop_session') then
