    ...
    loop
        ...
        from
            ...
            select
                ...
                sum(tho.read_operation_count_delta) as read_operation_count,
                sum(tho.write_operation_count_delta) as write_operation_count,
                sum(tho.other_operation_count_delta) as other_operation_count,
                sum(tho.read_transfer_count_delta) as read_transfer_count,
                sum(tho.write_transfer_count_delta) as write_transfer_count,
                sum(tho.other_transfer_count_delta) as other_transfer_count,
                case
